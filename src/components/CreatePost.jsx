  ...
  addPost(userId, postTitle,postBody,reactions,tags)
   ...
   return (
    ...
    <div className="mb-3">
      ...
      <input type="text" ref={reactionsElement} className="form-control" id="reactions"  placeholder='how many people to this post ' />
     
    </div>
    <div className="mb-3">
      <label htmlFor="hashtag" className="form-label">Enter your hashtag here</label>
